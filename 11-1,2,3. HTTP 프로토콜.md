...
<img width="730" alt="image" src="https://user-images.githubusercontent.com/69442847/204971602-50aeb2e9-fee9-4e17-8e74-c6112737c2ac.png">
 
<img width="803" alt="image" src="https://user-images.githubusercontent.com/69442847/204971828-fbbc07c9-2d28-4532-b1f3-d77f09d87e08.png">
...
* 가장 중요한 메소드 : GET, POST
* GET과 POST의 차이 : 
둘 다 데이터를 보내면서 요청할 수 있는데, GET은
URI(주소창)에 데이터를 포함시켜서 보내고 (외부로 노출됨), POST는 바디에 포함시켜서 보낸다.
* PUT은 보내면 바로 데이터가 반영되기 때문에 보안에 취약해 잘 사용하지 않음
